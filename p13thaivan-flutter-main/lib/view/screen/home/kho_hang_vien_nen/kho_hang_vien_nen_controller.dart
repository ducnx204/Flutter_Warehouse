...
class KhoHangVienNenController extends GetxController {
  ...
  void getProduct() {
    productProvider.paginate(
        page: 1,
        limit: 100,
        filter: "idCategory=6160dea2f8cf18614b7f119c",
        onSuccess: (value) {
          productList = value;
          isLoading = false;
          update();
  ...
  void onItemClick(){
    ...
    Get.to(OrderConditionPage(user: userModel!, isRegister: false, isCondition: false,));
  }
